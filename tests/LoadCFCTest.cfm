...
<head>
	...
	<script language="javascript" type="text/javascript">
		...
		RemoteObjectLoader("DemoObject.cfc", myCallback, true) 
		var core = null;
		...
		function getNumberForDemo()
		{
			dh = new DefaultHandler(doThing);
			core.getNumber(dh.handle);
		}
		
		function getDateForDemo()
		{
			dh = new DefaultHandler(doThing);
			core.getDate(dh.handle);
		}
...
<body>
	...
	<form>
	    ...
	    <input type="button" value="getNumber" onclick="javascript: getNumberForDemo()">
	    <input type="button" value="getDate" onclick="javascript: getDateForDemo()">
