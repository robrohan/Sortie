/**
 * File: xml/XmlW3CDom.js
 * a W3C compliant DOM parser for XML for <SCRIPT>
 *
 * Version:
 * 	3.1
 *
 * Copyright:
 * 	(C) 2002, 2003, 2004 Jon van Noort (jon@webarcana.com.au), David Joham (djoham@yahoo.com) and Scott Severtson
 *
 * License:
 ...
 *  Copyright (c) 16 November 1999 World Wide Web Consortium,
 *  (Massachusetts Institute of Technology,
 *  European Research Consortium for Informatics and Mathematics, Keio University).
 *  All Rights Reserved.
 *  (see: http://www.w3.org/TR/2000/WD-DOM-Level-1-20000929/)
 */
if(typeof XMLSAX_VERSION == "undefined") {
	alert("Fatal Error: XMLW3DOM is missing required libraries");
	throw new Error("xmlw3dom.js missing required libraries");
}

var XMLW3DOM_VERSION = "3.1";
 ...
 *
 * Parameters:
 * 	classCollectionStr - string list of existing class names (separated and top and tailed with '|'s)
 *	newClass - string new class name to add
 *
 * Returns: 
 * 	string - the new classCollection, with new className appended, (separated and top and tailed with '|'s)
 */
 ...
 *
 * Parameters
 * 	code - int the exception code (one of the DOMException constants)
 */
...
/**
 * Method: DOMImplementation.escapeString 
...
DOMDocument.prototype._genId = function DOMDocument__genId() {
	// increment lastId (to generate unique id)
  this._lastId += 1;                             
