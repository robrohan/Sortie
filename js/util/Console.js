 ...
 * This is libraries for an interactive console tied to a textarea. To use this
...
var PROMPT_A = "[neuro@" + window.location.host + "]:~# ";
var PROMPT_B = "[neuro@" + window.location.host + "]:~$ ";
...
function __con__help()
{
	...
	//neuro_SystemOut("| Neuromancer v: " + SYSTEM_VERSION + " " + NEWLINE);
	//neuro_SystemOut("| CURRENT MODE: " + TERMINAL_TYPE + " " + NEWLINE);
	neuro_SystemOut("|"+ NEWLINE);
	neuro_SystemOut("| Commands:" + NEWLINE);
	neuro_SystemOut("|---------------------------------------------------------------" + NEWLINE);
	neuro_SystemOut("| reflect(object)   - show object innards"+NEWLINE);
	//neuro_SystemOut("| loadws('service') - service must be in the 'ws' dir"+NEWLINE);
	...
	//neuro_SystemOut("| all normal system commands (in system mode)"+NEWLINE);
	neuro_SystemOut("----------------------------------------------------------------"+NEWLINE);
	neuro_Runner("");
}
